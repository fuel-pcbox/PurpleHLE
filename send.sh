...
###################################################################################################################
# !!! THIS SCRIPT IS BY k3rn31p4nic (k3rn31p4nic#8383) [https://github.com/k3rn31p4nic/travis-ci-discord-webhook] #
# copied to PurpleHLE because modification lol                                                                    #
###################################################################################################################
...
(curl --fail --progress-bar -A "TravisCI-Webhook" -H Content-Type:application/json -H X-Author:0xFF#8029 -d "$WEBHOOK_DATA" "$2" \
